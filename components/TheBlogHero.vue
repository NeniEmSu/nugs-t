<template>
  <article class="hero">
    <nuxt-link :to="`/news-blogs/${heroArticle.slug}`">
      <div class="date">
      ...
      <div class="meta">
        <h2 v-html="heroArticle.title.rendered"></h2>
        <div v-html="heroArticle.excerpt.rendered"></div>
      </div>
      <div v-if="featuredImage" class="featured-image lazy">
        <div class="image-height" :style="paddingTop"></div>
        <div v-lazy:backgroundImage="featuredImage.source_url" class="image"></div>
        <Spinner1 />
      </div>
    </nuxt-link>
  </article>
